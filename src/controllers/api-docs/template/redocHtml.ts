...
<html>
<head>
    <title>plus0-service API Documentation</title>
...
<script>
  ...
  try {
    initialLocalStorage = JSON.parse(localStorage.getItem('plus0-service-gui-v2') || '{}');
  } catch (e) {
...
<script>
 console.log('%c🚀 We are Hiring!!! 🚀%c\\n%cJoin the forces http://careers.plus0-service.com', 'color:#1348ba;font-size:3rem;padding:20px;', 'display:none', 'font-size:1.5rem;padding:20px')
   const linkEl = document.createElement('a')
  linkEl.setAttribute('href', "http://careers.plus0-service.com")
