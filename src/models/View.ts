import { isSystemColumn, UITypes, ViewTypes } from 'plus0-sdk';
import type { BoolType, ColumnReqType, ViewType } from 'plus0-sdk';
...
export default class View implements ViewType {
  ...
  static async insert(
    ...
    if (!(view.dataset_id && view.dataset_id)) {
  ...
  > {
    ...
    if (existingCol) {
      ...
      return await ncMeta.metaInsert2(view.project_id, view.dataset_id, table, {
        fk_view_id: viewId,
        fk_column_id: fkColId,
        order: colData.order,
        show: colData.show,
