...
import { isLinksOrLTAR, RelationTypes } from 'plus0-sdk';
...
import type { TableType } from 'plus0-sdk';
...
export async function importLTARData({
  ...
  for (const colMeta of modelMeta.columns) {
    ...
    // self links: skip if the column under consideration is the add-on column plus0-service creates
